...
func (c *queryServiceClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (*QueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rag.v1.QueryService/Query", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryServiceClient) BatchQuery(ctx context.Context, in *BatchQueryRequest, opts ...grpc.CallOption) (*BatchQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/rag.v1.QueryService/BatchQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueryService_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rag.v1.QueryService/Query",
	}
...
func _QueryService_BatchQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rag.v1.QueryService/BatchQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var QueryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rag.v1.QueryService",
