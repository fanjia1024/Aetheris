...
- [ ] Add `aetheris migrate` subcommand (e.g. schema or config migration) and document in docs/cli.md.
- [ ] Add `aetheris monitor` (e.g. job/worker status, queue depth) and document.
- [ ] Extend or document `aetheris replay` for 2.0 (replay options, output format).
- [ ] Update README and docs with new CLI commands.
...
- [ ] Update Makefile with 2.0 targets (e.g. run-api, run-worker, run-all, test-integration).
- [ ] Add or update scripts for local 2.0 stack (e.g. Postgres + API + Worker).
- [ ] Document one-command run and required env in README or get-started.md.
...
| 4 | CLI migrate, monitor, replay | Add aetheris migrate and document | Todo |
| 4 | CLI migrate, monitor, replay | Add aetheris monitor and document | Todo |
| 4 | CLI migrate, monitor, replay | Extend/document aetheris replay for 2.0 | Todo |
| 4 | CLI migrate, monitor, replay | Update README and docs | Todo |
...
| 4 | Makefile/scripts for 2.0 services | Update Makefile with 2.0 targets | Todo |
| 4 | Makefile/scripts for 2.0 services | Scripts for local 2.0 stack | Todo |
| 4 | Makefile/scripts for 2.0 services | Document one-command run | Todo |
